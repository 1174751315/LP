package prediction.core.predictor.util;

import common.ElementPrintableLinkedList;
import common.PrintableLinkedList;

import prediction.core.predictor.WorkdayPredictorTestDataRepo;

import prediction.domain.*;
...
public class CommonUtilsTest {
    ...
    public void testGetHistoryWeather() throws Exception {
        ElementPrintableLinkedList<ElementPrintableLinkedList<WeatherData>> weas =
            commonUtils.getHistoryWeather(mock2DSimpleDates);
    ...
    private void init() throws Exception {
        ...
        when(mockWeatherObtainer.tryGetSomeWeathers(any(List.class)))
                .thenReturn(WorkdayPredictorTestDataRepo.INSTANCE.predictionWeathers);
        when(mockLoadObtainer.tryGetSomeLoads(any(List.class)))
                .thenReturn(WorkdayPredictorTestDataRepo.INSTANCE.getLoadDatas());
        ...
        SimpleDate simpleDate = new SimpleDate("2014-04-02",
                new SimpleDateType(), new SimpleDateWeatherType());
