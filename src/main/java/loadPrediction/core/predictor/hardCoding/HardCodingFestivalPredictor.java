...
/**
 * 李倍存 创建于 2015/3/10 20:15。电邮 1174751315@qq.com。
 */
public class HardCodingFestivalPredictor extends AbstractTemplateMethodForHardCodingPredictor {
    public HardCodingFestivalPredictor(Date date) {
        super(date, true);
    }
