...
import prediction.aop.BeanFactory;
import prediction.core.predictor.excelling.ExcellingQingmingPredictor;
...
//            IPredictor predictor=new ExcellingWeekendPredictor();
        ...
        if (daoSimpleDate.query(ds).getDateType().getCode() == 0 && powerSystemDateUtil.isPowerSystemWorkday(date)) {
