...
import prediction.config.ConfigureFactory;
import prediction.config.WorkdayPredictorCfg;
import prediction.config.predictionCalculator.XmlCalculatorCfg;
import prediction.core.EnhancedSimilarCoeCalculator;
import prediction.core.predictor.IWorkdayPredictor;
import prediction.core.predictor.visitors.IPredictorVisitor;
import prediction.core.workday.IPredictionLoadTupleCalculator;
import prediction.core.workday.PredictionLoadTupleCalculatorWithPerUnit;
import prediction.dataAccess.DAOFactory;
import prediction.dataAccess.DAOLoadBase;
