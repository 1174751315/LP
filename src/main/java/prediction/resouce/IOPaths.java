...
public class IOPaths {
    ...
    public static final String WEB_CONTENT_WORKDAY_PREDICTOR_CFG_PATH =WEB_CONTENT_CONFIG+"workday_predictor_cfg.xml";
    public static final String WEB_CONTENT_WEEKEND_PREDICTOR_CFG_PATH =WEB_CONTENT_CONFIG+"weekend_predictor_cfg.xml";
